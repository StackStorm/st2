...
WORKFLOW_YAML = [f for f in fixture.WORKFLOW_YAMLS if 'workflow-v2.yaml' in f][0]
...
class TestMistralRunner(DbTestCase):
    ...
    def test_launch_workflow(self):
        ...
        execution = ActionExecutionDB(
            action={'name': 'workflow-v2'}, parameters={'friend': 'Rocky'})
    ...
    def test_callback(self):
        execution = ActionExecutionDB(
            action={'name': 'local'}, parameters={'cmd': 'uname -a'},
