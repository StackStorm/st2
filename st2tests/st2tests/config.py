...
def _register_garbage_collector_opts():
    ...
    ttl_opts = [
        ...
        cfg.IntOpt(
            ...
            default=None,
            help="Workflow execution output objects (ones generated by action output streaming) older than this value (days) will be automatically deleted. Defaults to None (disabled).",
        ),
        cfg.IntOpt(
            "task_executions_ttl",
            default=None,
            help="Task execution output objects (ones generated by action output streaming) older than this value (days) will be automatically deleted. Defaults to None (disabled).",
        ),
    ]
