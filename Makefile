...
.st2common-circular-dependencies-check:
	...
	find ${ROOT_DIR}/st2common/st2common/ \( -name \*.py ! -name runnersregistrar\.py ! -wholename "*runners/__init__.py" ! -name python_action_wrapper.py \) -type f -print0 | xargs -0 cat | grep st2actions ; test $$? -eq 1
