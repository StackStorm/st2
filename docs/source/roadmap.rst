...
* **Web UI:** refactor history view, create and edit rules and workflows, add graphical representations for workflow definitions and liveactions.
* **Improving** `Mistal <https://wiki.openstack.org/wiki/Mistral>`_  **integration:** focus on simplifying Mistral DSL for |st2| actions, visibility of workflow liveactions, and reliability of |st2|-Mistral communication.
