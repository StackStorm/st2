...
def inject_st2_pth_into_virtualenv(virtualenv_path: str) -> None:
    """
    ...
    contents = dedent(
        ...
        f"""# This file is auto-generated by StackStorm.
        import site; site.addsitedir('{parent_site_packages_dir}')
        """
