...
from st2common.transport.reactor import TRIGGERS_CUD_XCHG, TRIGGER_INSTANCES_XCHG
from st2common.transport.reactor import SENSORS_CUD_XCHG

LOG = logging.getLogger('st2common.transport.bootstrap')

EXCHANGES = [EXECUTION_XCHG, LIVEACTION_XCHG, TRIGGERS_CUD_XCHG, TRIGGER_INSTANCES_XCHG,
             SENSORS_CUD_XCHG]
