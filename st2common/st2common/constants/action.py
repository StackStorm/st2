...
LIVEACTION_STATUSES = [LIVEACTION_STATUS_SCHEDULED,
                       LIVEACTION_STATUS_RUNNING, LIVEACTION_STATUS_SUCCEEDED,
                       LIVEACTION_STATUS_FAILED, LIVEACTION_STATUS_CANCELED]

ACTION_OUTPUT_RESULT_DELIMITER = '%%%%%~=~=~=************=~=~=~%%%%'

CANCELABLE_STATES = [LIVEACTION_STATUS_SCHEDULED, LIVEACTION_STATUS_RUNNING]
