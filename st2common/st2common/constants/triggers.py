...
__all__ = [
    ...
    'TRIGGER_INSTANCE_STATUS_PENDING',
    'TRIGGER_INSTANCE_STATUS_PROCESSING',
    'TRIGGER_INSTANCE_STATUS_PROCESSED',
    'TRIGGER_INSTANCE_STATUS_PROCESSING_FAILED'
]
...
TRIGGER_INSTANCE_STATUS_PENDING = 'pending'
TRIGGER_INSTANCE_STATUS_PROCESSING = 'processing'
TRIGGER_INSTANCE_STATUS_PROCESSED = 'processed'
TRIGGER_INSTANCE_STATUS_PROCESSING_FAILED = 'processing_failed'
