...
from st2common.constants.action import PARAM_FILE_LOCATION
...
def get_file_params_path(execution_id):
    """Returns file path for file params

    :param execution_id: Execution ID of action execution.
    :type execution_id: ``str``
    """
    return os.path.join(PARAM_FILE_LOCATION, PARAM_FILE_PREPEND + execution_id)
